...
| [featurizer-passthrough-features.md](featurizer-passthrough-features.md) | featurizer v0.9.x text/graph feature families + native `graph_relationships`, and how triage-pg reaches them via config passthrough (ADR-0008). |
