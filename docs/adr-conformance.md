...
| 0008 | featurizer replaces Collate | fulfilled | Pin `pyproject.toml:31` = `featurizer[parquet] @ …@v1.0.1` (stability release line, API frozen; 1.0.1 = the empty-primitive-list fix triage-pg surfaced 2026-08-07); `component/collate` gone; scale validated (`docs/featurizer-scale.md`), re-validated v0.4.1/v0.8.0; v0.9.x additive families reachable via passthrough (`docs/featurizer-passthrough-features.md`) |
