...
| 0008 | featurizer replaces Collate | fulfilled | Pin `pyproject.toml:31` = `featurizer[parquet] @ …@v1.0.0` (stability release, API frozen); `component/collate` gone; scale validated (`docs/featurizer-scale.md`), re-validated v0.4.1/v0.8.0; v0.9.x additive families reachable via passthrough (`docs/featurizer-0.9-features.md`) |
