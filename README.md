...
No local Python at all: every release ships a public container — `docker pull ghcr.io/ccd-ia/triage-pg:v1.1.1` gives you the `triage` CLI (and a `dashboard` image stage) against any PostgreSQL you point it at.
